...
import { moveItemInArray, CdkDropListGroup, CdkDropList, CdkDrag, CdkDragMove, CdkDragDrop } from '@angular/cdk/drag-drop';
...
export class HandComponent implements OnInit {
  ...
  constructor(private viewportRuler: ViewportRuler, private cardGameService: CardGameService) {
    this.target = null;
    this.source = null;
  ...
  dropListDropped(event: CdkDragDrop<string[]>) {
    ...
    if (this.sourceIndex != this.targetIndex)
      moveItemInArray(this.currentHand, this.sourceIndex, this.targetIndex);
  }
